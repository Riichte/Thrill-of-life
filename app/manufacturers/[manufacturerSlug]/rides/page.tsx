  ...
  return (
    <div className="min-h-screen style={{ background: 'var(--bg-tertiary)' }} style={{ color: 'var(--text-primary)' }}">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="style={{ color: 'var(--text-muted)' }} mb-8">{rides.length} rides found</p>
            ...
            return (
              <Link key={item.id} href={`/parks/${item.park_id}/${item.category_id}/${item.id}`}
                ...
                <div className="p-3">
                  ...
                  <p className="text-xs style={{ color: 'var(--text-muted)' }} mt-0.5 truncate">{(item.parks as any)?.name ?? ''}</p>
