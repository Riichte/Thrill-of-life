...
export const mockItems: Record<string, any[]> = {
  'disneyland-paris': [
    { id: 'space-mountain', category_id: 'rides', name: 'Space Mountain', description: 'A thrilling indoor roller coaster through the darkness of space.', location_in_park: 'Discoveryland', specs: { height: '42m', speed: '65 km/h', length: '900m', drop: '35m', manufacturer: 'Arrow Dynamics', type: 'Indoor Roller Coaster' } },
  ...
  'port-adventure': [
    ...
    { id: 'ferrari-land', category_id: 'shops', name: 'Ferrari Land Shop', description: 'Exclusive Ferrari merchandise and memorabilia for collectors.', location_in_park: 'Ferrari Land' }
  ],
  'europa-park': [
    { id: 'wodan', category_id: 'roller-coasters', name: 'Wodan', description: 'A thrilling wooden roller coaster with breathtaking drops and high speeds.', location_in_park: 'Iceland', specs: { height: '40m', speed: '100 km/h', length: '1050m', drop: '35m', manufacturer: 'Bolliger & Mabillard', type: 'Wooden Roller Coaster' } },
    { id: 'euromir', category_id: 'roller-coasters', name: 'Euromir', description: 'A looping roller coaster that simulates a journey to space.', location_in_park: 'France', specs: { height: '35m', speed: '80 km/h', length: '850m', drop: '30m', manufacturer: 'Bolliger & Mabillard', type: 'Inverted Roller Coaster' } },
    { id: 'blue-fire', category_id: 'roller-coasters', name: 'Blue Fire', description: 'A high-speed launched coaster that propels riders through intense inversions.', location_in_park: 'Iceland', specs: { height: '38m', speed: '100 km/h', length: '1056m', drop: '30m', manufacturer: 'Mack Rides', type: 'Launched Roller Coaster' } },
    ...
    { id: 'matterhorn-blitz', category_id: 'roller-coasters', name: 'Matterhorn Blitz', description: 'A wild bobsled coaster through alpine scenery.', location_in_park: 'Switzerland', specs: { height: '12m', speed: '50 km/h', length: '320m', drop: '10m', manufacturer: 'Mack Rides', type: 'Bobsled Coaster' } },
    ...
    { id: 'fjord-rafting', category_id: 'water-rides', name: 'Fjord Rafting', description: 'A rapid river adventure ride through Norwegian fjord scenery.', location_in_park: 'Scandinavia', specs: { height: '8m', speed: 'Variable', length: '360m', drop: '5m', manufacturer: 'Intamin', type: 'River Rapids Ride' } },
    { id: 'dschungel-flossfahrt', category_id: 'dark-rides', name: 'Dschungel-Floßfahrt', description: 'A relaxing boat ride through lush jungle scenery.', location_in_park: 'Adventureland', specs: { height: '3m', speed: 'Variable', length: '300m', drop: '2m', manufacturer: 'Mack Rides', type: 'Boat Ride' } },
    ...
    { id: 'eurosat', category_id: 'roller-coasters', name: 'Eurosat', description: 'A high-speed roller coaster with multiple inversions.', location_in_park: 'France', specs: { height: '32m', speed: '90 km/h', length: '380m', drop: '28m', manufacturer: 'Bolliger & Mabillard', type: 'Inverted Coaster' } },
    ...
    { id: 'alpenexpress', category_id: 'roller-coasters', name: 'Alpenexpress', description: 'A mountain train ride through scenic alpine landscapes.', location_in_park: 'Austria', specs: { height: '5m', speed: 'Variable', length: '350m', drop: '3m', manufacturer: 'Mack Rides', type: 'Train Ride' } },
